...
def BobotMolekul(): # type: ignore
    pilihan = st.sidebar.selectbox('Menu', ['Daftar Unsur', 'Kalkulator Senyawa', 'Latihan Soal'])
    if pilihan == 'Daftar Unsur': DisplayUnsur() # type: ignore
    elif pilihan == 'Kalkulator Senyawa': BobotMolekul() # type: ignore
    elif pilihan == 'Latihan Soal': BobotMoleku() # type: ignore
